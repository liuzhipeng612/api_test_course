...
from data.enter_class_data import (test_data, post_step_data, pre_step_data, execute_step_data,
                                   function_post_step_data, function_pre_step_data)
from page.base_page import BasePage


class EnterClass(BasePage):
    """
